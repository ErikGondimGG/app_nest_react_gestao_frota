-- CreateSchema
CREATE SCHEMA
IF NOT EXISTS "Base api_bot_wpp";
...
-- AddForeignKey
ALTER TABLE "Base api_bot_wpp"."veiculos" ADD CONSTRAINT "veiculos_tipo_veiculo_id_fkey" FOREIGN KEY ("tipo_veiculo_id") REFERENCES "Base api_bot_wpp"."tipos_veiculos"("id")
